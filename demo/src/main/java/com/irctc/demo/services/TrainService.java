...
public class TrainService {
    ...
    private static final String TRAIN_DB_PATH = "demo/src/main/java/com/irctc/demo/localDB/trains.json";
    ...
    public List<Train> searchTrains(String source, String destination) {
        return trainList.stream()
                .filter(train -> train.getSourceStation().equalsIgnoreCase(source) && train.getDestinationStation().equalsIgnoreCase(destination))
    ...
    private boolean validTrain(Train train, String source, String destination) {
        if (train.getStations() == null) { // Added null check for stationOrder
            return false;
        }
